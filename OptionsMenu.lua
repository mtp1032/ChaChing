...
local function createOptionsPanel()
	...
	local str2 = string.format("all saleable items in the selected bag the next time you\n")
	local str3 = string.format("a merchant.\n")
	frame.messageText:SetFormattedText("%s%s%s\n", str1, str2, str3 )
