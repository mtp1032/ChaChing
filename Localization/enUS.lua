...
L["ADDON_NAME_AND_VERSION"] = string.format("%s - %s (%s)", ADDON_NAME, addonVersion, addonExpansion)
DEFAULT_CHAT_FRAME:AddMessage(string.format("%s is loaded", L["ADDON_NAME_AND_VERSION"]), 0, 1, 0)
